...
- [ ] Optimizer/sim refinements Phase 2: allow duplicate lineups (tracked and reported, with payout correctly split across identical entries sharing a rank) and a soft preference for high-salary/high-FPTS players in a partial stack's leftover one-off slots
